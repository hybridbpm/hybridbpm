...
public abstract class AbstractTableLayout extends VerticalLayout implements Button.ClickListener, Window.CloseListener {

    private static final Logger logger = Logger.getLogger(AbstractTableLayout.class.getSimpleName());
